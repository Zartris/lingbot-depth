...
# NOTE: this is the MUTABLE student copy of the model stack (see distill/program.md).
# The teacher's mdm/model/ is frozen; edit THIS tree to change the student network.
# Geometry helpers are shared, pure math — imported from the frozen package rather
# than duplicated.
from .modules_rgbd_encoder import DINOv2_RGBD_Encoder
from .modules_decoder import MLP, ConvStack
from mdm.utils.geo import depth_to_pointcloud, normalized_view_plane_uv
